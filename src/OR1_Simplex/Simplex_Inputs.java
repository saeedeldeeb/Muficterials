    ...
    constr = new JPanel[Connumber2];
        ...
        for (int i = 0; i < constr.length; i++) {
         ...
         constr[i].setBackground(new Color(101,39,129));
            ...
            GreatLess[i] = new JComboBox(greatless);
...
//                constr[k].add(Varnameconstr[i]);
    ...
    btn.addActionListener(new ActionListener() {
        ...
        constraintOperator[i] = Constraint.lessThan ;
                ...
                Modeler(leftValue, rightValue, constraintOperator, objFunction);
                
                if("MAX".equals(Objmaxmin)){
                Simplex_Output out = new Simplex_Output(arrtable, Connumber2, Varnumber1, true);
                out.setLocationRelativeTo(null);
                out.setVisible(true);
                }
                else
                            if("MIN".equals(Objmaxmin)){
                  Simplex_Output out = new Simplex_Output(arrtable, Connumber2, Varnumber1, false);
                out.setLocationRelativeTo(null);
                out.setVisible(true);
                }else{
  ...
  lessThan, equal, greatherThan
    ...
    double[] constraintRightSide, Constraint[] constraintOperator,double[] objectiveFunction){
