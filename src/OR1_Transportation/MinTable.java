 ...
 * @author dell
 */
public class MinTable extends JFrame{
    ...
    public MinTable(int S_number , int D_number , double [][] Cost_array){
    ...
    double MinCost = 100000 ;
        ...
        for (int i = 0; i < S_Array.length ; i++) {
            ...
            for (int j = 0; j < D_Array.length ; j++) {
                   ...
                   if(Costs_Array[i][j] < MinCost && NW_Value[i][j] == 0){
    ...
    // Add
                    ...
                    for(;;){
                        ...
                        MinCost();
                            ...
                            if(NW_Value[indexS][indexD] == 0){
                            
                            
                            if(S_Array[indexS] > D_Array[indexD] ){
                            
                            NW_Value[indexS][indexD] = D_Array[indexD] ;
                            
                            S_Array[indexS] = S_Array[indexS] - NW_Value[indexS][indexD] ;
                            D_Array[indexD] = D_Array[indexD] - NW_Value[indexS][indexD] ;
        ...
        for (int k = 0; k < D_Array.length; k++) {
            ...
            System.out.println(D_Array[k]);            
                              ...
                              CN_LP[indexS][indexD].setText("           "+NW_Value[indexS][indexD]+" * "+Costs_Array[indexS][indexD]);
                            
                            
                            TotalCost += NW_Value[indexS][indexD]*Costs_Array[indexS][indexD] ;
                            
                                
                                    for (int l = 0 ; l < S_Array.length ; l++) {
                                        
                                        if(NW_Value[l][indexD] <= 0){
                                ...
                                NW_Value[indexS][indexD] = S_Array[indexS] ;
            ...
            System.out.println(D_Array[k]);            
                            ...
                            TotalCost += NW_Value[indexS][indexD]*Costs_Array[indexS][indexD] ;
                                ...
                                for (int l = 0 ; l < D_Array.length ; l++) {
                                 ...
                                 if(NW_Value[indexS][indexD] == -1){
                                 
                              CN_LP[indexS][indexD].setText("                X ");
